...
Native tab reordering works within a group. Dragging between groups, floating
windows, and layout persistence are not implemented yet. Future drag handling
should resolve a target and call `DockWindow`, reusing these operations.
